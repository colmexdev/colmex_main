...
academicosPorTema = data.dimension(function(d){console.log("Temas: " + d["libres"].join(" ")); return d["libres"].join(" ")});
academicosPorLinea = data.dimension(function(d){ console.log("Líneas: " + d["libres"].join(" "));return d["conts"].join(" ")});
