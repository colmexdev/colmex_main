        ...
        init: function(lightbox) {
            ...
            lightbox.on("showitem.uk.lightbox", function(e, data){
                ...
                var id, matches, resolve = function(id, width, height) {
                    ...
                    data.meta = {
                        'content': '<iframe src="//www.youtube.com/embed/'+id+'" width="'+(window.innerWidth*0.95 > 1390 ? 1390 : window.innerWidth * 0.95) /*width*/+'" height="'+/*height*/(window.innerWidth*0.95 > 1390 ? 1390*9/16 : window.innerWidth * 0.95 * 9 / 16)+'" style="max-width:100%;"'+(modal.lightbox.options.allowfullscreen?' allowfullscreen':'')+'></iframe>',
                        'width': /*width*/(window.innerWidth*0.95 > 1390 ? 1390 : window.innerWidth * 0.95),
                        'height': /*height*/(window.innerWidth*0.95 > 1390 ? 1390*9/16 : window.innerWidth * 0.95 * 9 / 16)
                    };
