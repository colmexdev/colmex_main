class PrincipalController < ApplicationController
  def principal
    ...
    @descubre = Descubre.where("fecha_publicacion <= ? AND fecha_limite_pub >= ? AND titulo not like 'Charlas por la igualdad de g_nero y la diversidad sexual' and titulo not like 'Bolet_n de investigaci_n'", Date.current(), Date.current()).order("RAND()")
