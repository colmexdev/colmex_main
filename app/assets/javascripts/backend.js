...
function extendTrix(toolbar,blocks){
 		...
 		var buttonHTML3 = "<button type=\"button\" class=\"trix-button trix-button--icon\" data-trix-attribute=\"heading2\" title=\"Heading2\" tabindex=\"-1\"><div style=\"display:inline-block;font-size:14px;width:100%;\">H2</div></button>";
 		var buttonHTML4 = "<button type=\"button\" class=\"trix-button trix-button--icon\" data-trix-attribute=\"heading3\" title=\"Heading3\" tabindex=\"-1\"><div style=\"display:inline-block;font-size:12px;width:100%;\">H3</div></button>";
