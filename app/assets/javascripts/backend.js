...
function extendTrix(toolbar,blocks){
		...
		Trix.config.textAttributes.italic.tagName = "i";
 		...
 		var buttonHTML4 = "<button type=\"button\" class=\"trix-button trix-button-icon\" data-trix-attribute=\"heading3\" title=\"Heading3\" tabindex=\"-1\"><div style=\"display:inline-block;font-size:13px;\">H3</div></button>";
 		var buttonHTML5 = "<button type=\"button\" class=\"trix-button trix-button-icon\" data-trix-attribute=\"left\" title=\"Left\" tabindex=\"-1\"><div style=\"display:inline-block;\"><i class=\"fa fa-align-left\" aria-hidden=\"true\"></i></div></button>";
 		var buttonHTML6 = "<button type=\"button\" class=\"trix-button trix-button-icon\" data-trix-attribute=\"center\" title=\"Center\" tabindex=\"-1\"><div style=\"display:inline-block;\"><i class=\"fa fa-align-center\" aria-hidden=\"true\"></i></div></button>";
 		var buttonHTML7 = "<button type=\"button\" class=\"trix-button trix-button-icon\" data-trix-attribute=\"right\" title=\"Right\" tabindex=\"-1\"><div style=\"display:inline-block;\"><i class=\"fa fa-align-right\" aria-hidden=\"true\"></i></div></button>";
 		var buttonHTML8 = "<button type=\"button\" class=\"trix-button trix-button-icon\" data-trix-attribute=\"justify\" title=\"Justify\" tabindex=\"-1\"><div style=\"display:inline-block;\"><i class=\"fa fa-align-justify\" aria-hidden=\"true\"></i></div></button>";
