module PrincipalHelper
  ...
  def construirEvento(fila, chico = false)
    ...
    bloque_html = bloque_html + ( centros.include?(fila["centroSiglas"].downcase) ? ActionController::Base.helpers.image_tag(fila["centroSiglas"].mb_chars.downcase.split(/ *, */) + ".png", :class => "img_sede") : '') + "</div>"
