module PrincipalHelper
  ...
  def construirEvento(fila)
    ...
    bloque_html = bloque_html + '<div class="titulo_evento"><div class="fade">' + fila["tituloActividad"].to_s + (fila["subtituloActividad"].to_s != "" ? (": " + fila["subtituloActividad"].to_s) : "") + "</div></div>"
