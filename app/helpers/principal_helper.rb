...
<br><span>' + fila["institucionSede"].to_s + "</span></p></div></div>"
  ...
  def construir_descubre(descubres)
    ...
    descubres.each do |d|
      ...
      bloque_html = bloque_html + "<a onclick=\"ga('send', 'event', 'Link de Descubre', 'Visualizacion', "+ d.contenido + ");\" href=\""+ d.liga + "\" " + (d.contenido.mb_chars.downcase == "video" ? ("data-uk-lightbox data-lightbox-type=\"iframe\"") : "target=\"_blank\"" ) + "><div class=\"frame-hover\" id=\"frame-" + i.to_s + "-hov\">"
      bloque_html = bloque_html + "<p><span class=\"cont-descubre\">" + d.contenido.mb_chars.upcase + "</span></p>"
