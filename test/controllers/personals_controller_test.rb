...
class PersonalsControllerTest < ActionController::TestCase
  ...
  test "should create personal" do
    assert_difference('Personal.count') do
      post :create, personal: { cargo: @personal.cargo, correo: @personal.correo, depto: @personal.depto, extension: @personal.extension, nombre: @personal.nombre, seccion: @personal.seccion, telefono: @personal.telefono }
    end
  ...
  test "should update personal" do
    patch :update, id: @personal, personal: { cargo: @personal.cargo, correo: @personal.correo, depto: @personal.depto, extension: @personal.extension, nombre: @personal.nombre, seccion: @personal.seccion, telefono: @personal.telefono }
    assert_redirected_to personal_path(assigns(:personal))
  end
