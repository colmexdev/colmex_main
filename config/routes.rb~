Rails.application.routes.draw do
  ...
  scope "(:locale)", locale: /(en)|(es)/ do
    ...
    get 'catedras-y-seminarios' => "programas_academicos#catedras_y_seminarios", :as => :catedras_seminarios
    ...
    get 'emeritos' => 'informacion_general#profesores_emeritos', :as => :profesores_emeritos
    ...
    get 'aviso-de-privacidad' => 'principal#aviso_de_privacidad', :as => :aviso
  end
